...
import com.biometrics.model.ProcessingParams
 ...
 * This service handles uploading fingerprint images to the server and receiving processed results.
 */
object FingerprintApiService {
    ...
    /**
     * Configure the API service with a custom base URL
     */
    ...
    suspend fun processFingerprints(
        ...
        try {
            ...
            val url = "$baseUrl/process-images?thickness=$thickness&margin=$margin&crop=$crop&dpi=$dpi"
        ...
        for (i in 0 until processedArray.length()) {
            ...
            processedFiles.add(
                ProcessedFile(
                    ...
                    captured_png = fileObj.optString("captured_png", null),  // Optional field
